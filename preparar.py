...
Los tres archivos viven en la raiz de este repositorio y la API los espera
en backend/app/ml/. En vez de duplicarlos en el control de versiones, se
...
def main() -> int:
    ...
    if faltantes:
        ...
        print("Descargarlos de https://github.com/CbasLugo/artefactos-ml")
        return 1
